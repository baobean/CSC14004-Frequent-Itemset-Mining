...
\ifthenelse{\equal{\LanguageOption}{portuguese}}{%
    ...
    \noindent O presente trabalho beneficiou da utilização do modelo \textit{Report}.
    ...
    \noindent La presente disertación es un trabajo original, elaborado exclusivamente para este fin, habiendo sido debidamente citados todos los autores cuyos estudios contribuyeron a su elaboración. Se permite su reproducción parcial con indicación del autor y referencia al grado, año académico, institución---\textit{Politécnico de Leiria}---y fecha de defensa pública.
    ...
    \noindent La preparación de este trabajo fue facilitada por el uso de la plantilla \href{https://github.com/joseareia/ipleiria-thesis}{\textit{Report}}.
}{%
    \noindent \textbf{\GetTitle}
    ...
    \noindent Preparation of this work was facilitated by the use of the \href{https://github.com/joseareia/ipleiria-thesis}{\textit{Report}} template.
}}
