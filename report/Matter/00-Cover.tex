\ifthenelse{\equal{\CoverOption}{classic}}{
    ...
    \vfill
    \centering
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{Figures/Theme/Cover-BG-NB.pdf}%
    \vfill
    }}}
}{
    \newcommand\BackgroundPicCover{%
...
\begin{titlepage}
    ...
    \ifthenelse{\equal{\CoverOption}{classic}}{
        ...
        \ifthenelse{\equal{\SchoolOption}{hcmus}}{
            \begin{figure}
                \includegraphics[width=0.485\linewidth]{Figures/Theme/Logotypes/HCMUS-Logo-Wide-W.png}
            \end{figure}
        }{}
    } {
        \ifthenelse{\equal{\SchoolOption}{estg}}{
